    ...
    def post(self, request, *args, **kwargs):
        ...
        for file_obj in files:
            ...
            uploaded_file = UploadedFile.objects.create(
                user=request.user if request.user.is_authenticated else None, # We should probably enforce login later
...
class PreviewFileView(APIView):
    def get(self, request, file_id, *args, **kwargs):
        try:
            uploaded_file = UploadedFile.objects.get(id=file_id, user=request.user if request.user.is_authenticated else None)
